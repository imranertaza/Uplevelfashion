 ...
 */
class ModelExtensionPavpopulartagstag extends Model {		
	...
	private function generateTag($tags, $resize = true, $min_font_size = 9, $max_font_size = 25, $font_weight) {
		...
		if ($resize == true) {
			...
			foreach ($tags as $key => $value) {
				...
				$cloud[] = '<a href="' . $this->url->link('product/search', $filter_tag . $string) . '" style="text-decoration:none;font-size:' . $size . 'px;font-weight:' . $font_weight . ';" title="">' . $key . '</a> ';
			}
