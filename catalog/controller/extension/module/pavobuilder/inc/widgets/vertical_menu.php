...
class PA_Widget_Vertical_Menu extends PA_Widgets {
	public $header = true;
	public function fields(){
		return array(
			'mask'		=> array(
				'icon'	=> 'fa fa-th-list',
				'label'	=> $this->language->get( 'entry_mega_menu_ver' ),
			),
			'tabs'	=> array(
				'general'		=> array(
					...
					'fields'	=> array(
						...
						array(
							...
							'options'	=> array(
								...
								array(
									'value'	=> 'vertical-click-showed',
									'label'	=> 'Vertical Click Show from Left'
								)
							)
						),
						array(
	...
	public function render( $settings = array(), $content = '' ) {
		$settings['ismain'] = isset($settings['ismain']) && $settings['ismain'] ? true : false; 
 		$settings['menu']= $this->load->controller('extension/module/pavverticalmenu');
		return $this->load->view( 'extension/module/pavoheader/vertical_menu', array( 'settings' => $settings ) );
	}
