<?php
class PA_Widget_Product_Carousel extends PA_Widgets {
	...
	public function fields() {
		...
		return array(
			'mask'		=> array(
				...
				'label'	=> $this->language->get( 'entry_product_carousel' )
			),
			'tabs'	=> array(
				'general'		=> array(
	...
	public function render( $settings = array(), $content = '' ) {
		...
		$settings['products'] =   $products ? $this->getProducts( $products , $settings ) : array();
	  	...
	  	if (!empty($settings['layout'])) {
			...
			$args = 'extension/module/pavobuilder/pa_product_carousel/product_carousel';
		}
