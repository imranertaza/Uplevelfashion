 ...
 *
 */
class PavoThemerSkinCreatorHelper {
	...
	public function getSettings() {
 	...
 	public function getSkinData( $skin ){  
 		$file = DIR_CATALOG . 'view/theme/' . $this->theme . '/stylesheet/skins/'.$skin.'.json';
 		if( file_exists($file) ){
	...
	public function getSettingFiles() {
		return glob( DIR_CATALOG . 'view/theme/' . $this->theme . '/development/skin/*.xml' );
	}

	public function getCustomSkins() {
 
		$files =  glob( DIR_CATALOG . 'view/theme/' . $this->theme . '/stylesheet/skins/*.json' );
